  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div id="delete-content-info" class="alert alert-info alert-dismissible">
        ...
        Nội dung đã được xóa thành công!
      </div>
      <div id="delete-content-error" class="alert alert-danger alert-dismissible">
        ...
        <span>Có lỗi xảy ra khi xóa nội dung!</span>
      </div>
      <h1>
        Nội dung
      </h1>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default">
            ...
            <form:form id="contentForm" action="${contextPath}/content" modelAttribute="contentForm" method="post">
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="originalLink">Đường dẫn bài gốc</label>
                    <form:input type="text" class="form-control" path="originalLink" id="originalLink" placeholder="Đường dẫn bài gốc"/>
                    <form:errors path="originalLink" cssClass="has-error"></form:errors>
                  </div>
                </div>
              </div>
              <!-- /.row -->
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="contentsTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>Tiêu đề</th>
                  <th>Đường dẫn bài gốc</th>
                  <th>Ngày tạo</th>
                  <th>Trạng thái</th>
                  <th>Hành động</th>
                </tr>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="delete_content" class="btn btn-primary">Xóa</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
...
<script src="${contextPath}/resources/js/content.js"></script>
</body>
</html>
