      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="costReportsTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>Ngày</th>
...
<script src="${contextPath}/resources/bower_components/datatables.net/js/datetime-moment.js"></script>
<script>
    var serverContext = "${pageContext.request.contextPath}";
    $.widget.bridge('uibutton', $.ui.button);
</script>
<script src="${contextPath}/resources/js/common.js"></script>
<script src="${contextPath}/resources/js/report_cost.js"></script>
</body>
</html>
