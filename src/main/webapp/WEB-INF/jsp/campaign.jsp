      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Xóa chiến dịch quảng cáo</h4>
          </div>
          <div class="modal-body">
            <p>Bạn có chắc chắn muốn xóa chiến dịch quảng cáo này?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
            <button type="button" id="delete_campaign" class="btn btn-primary">Xóa</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
    ...
    <div class="modal fade" id="modal-active-deactive">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Bạn có chắc chắn muốn Kích hoạt/Hủy kích hoạt chiến dịch quảng cáo này?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
            <button type="button" id="active_deactive_campaign" class="btn btn-primary">Đồng ý</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
