    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
          <div class="box-body">
            <div class="chart">
              <canvas id="installsChart" style="height:250px"></canvas>
            </div>
          </div>
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="appReportsTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>Tên ứng dụng</th>
...
<script src="${contextPath}/resources/js/report_app.js"></script>
</body>
</html>
