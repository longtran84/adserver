      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default">
            ...
            <form:form id="appAdForm" action="${contextPath}/appAd" modelAttribute="appAdForm" method="post" enctype="multipart/form-data">
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <form:input type="file" id="iconFile" path="iconFile"/>
                    </div>
                    <form:errors path="iconFile" cssClass="has-error"></form:errors>
                  </div>
                  <div class="form-group">
                    <label for="installLink">Đường dẫn cài đặt *</label>
                    <form:input type="text" class="form-control" path="installLink" id="installLink" placeholder="Đường dẫn cài đặt"/>
                    <form:errors path="installLink" cssClass="has-error"></form:errors>
                  </div>
                </div>
                <!-- /.col -->
              </div>
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="appAdsTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>Tên ứng dụng</th>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Xóa ứng dụng quảng cáo</h4>
          </div>
          <div class="modal-body">
            <p>Bạn có chắc chắn muốn xóa ứng dụng quảng cáo này?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
            <button type="button" id="delete_appAd" class="btn btn-primary">Xóa</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">Định dạng và kích thước icon được hỗ trợ</h4>
          </div>
          <div class="modal-body">
...
<script src="${contextPath}/resources/js/appAd.js"></script>
</body>
</html>
