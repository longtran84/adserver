      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="userInvitesTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>ID người giới thiệu</th>
                  <th>Tên đăng nhập người giới thiệu</th>
                  <th>ID người dùng</th>
...
<script src="${contextPath}/resources/js/user_invite.js"></script>
<script>
