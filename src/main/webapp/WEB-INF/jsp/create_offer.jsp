...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="offerForm" class="form-signin">
        <h2 class="form-signin-heading">Create offer</h2>
        ...
        <spring:bind path="device">
            <div class="form-group ${status.error ? 'has-error' : ''}">
                <form:input type="text" path="device" class="form-control"
                            placeholder="Device"></form:input>
                <form:errors path="device"></form:errors>
            </div>
        </spring:bind>
