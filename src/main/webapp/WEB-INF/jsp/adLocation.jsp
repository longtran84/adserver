...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div id="delete-adLocation-info" class="alert alert-info alert-dismissible">
        <button type="button" id="delete_adLocation_close_info" class="close" aria-hidden="true">&times;</button>
        <h4><i class="icon fa fa-info"></i> Thông báo!</h4>
        Địa điểm quảng cáo đã được xóa thành công!
      </div>
      <div id="delete-adLocation-error" class="alert alert-danger alert-dismissible">
        <button type="button" id="delete_adLocation_close_error" class="close" aria-hidden="true">&times;</button>
        <h4><i class="icon fa fa-ban"></i> Thông báo!</h4>
        <span>Có lỗi xảy ra khi xóa địa điểm quảng cáo!</span>
      </div>
      <h1>
        Địa điểm quảng cáo
      </h1>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-default">
            ...
            <form:form id="adLocationForm" action="${contextPath}/adLocation" modelAttribute="adLocationForm" method="post">
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" path="lng" id="lng" placeholder="Kinh độ"/>
                    <form:errors path="lng" cssClass="has-error"></form:errors>
                  </div>
                  <div class="form-group">
                    <label for="lat">Vĩ độ (latitude) *</label>
                    <form:input type="text" class="form-control" path="lat" id="lat" placeholder="Vĩ độ"/>
                    <form:errors path="lat" cssClass="has-error"></form:errors>
                  </div>
                  <div class="form-group">
                    <label for="address">Địa chỉ</label>
                    <form:textarea class="form-control" path="address" id="address" rows="4" placeholder="Địa chỉ"/>
                    <form:errors path="address" cssClass="has-error"></form:errors>
                  </div>
                </div>
                <!-- /.col -->
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="name">Nội dung quảng cáo</label>
                    <form:textarea class="form-control" path="adContent" id="adContent" rows="4" placeholder="Nội dung quảng cáo"/>
                    <form:errors path="adContent" cssClass="has-error"></form:errors>
                  </div>
                  <!-- /.form-group -->
                </div>
                <!-- /.col -->
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="adLocationsTable" class="table table-bordered table-hover dataTable" role="grid">
                <!-- Header Table -->
                <thead>
                <tr>
                  <th>Tên</th>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">Xóa địa điểm quảng cáo</h4>
          </div>
          <div class="modal-body">
            <p>Bạn có chắc chắn muốn xóa địa điểm quảng cáo này?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
            <button type="button" id="delete_adLocation" class="btn btn-primary">Xóa</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
    ...
    <div class="modal fade" id="modal-active-deactive">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>Bạn có chắc chắn muốn Kích hoạt/Hủy kích hoạt địa điểm quảng cáo này?</p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
            <button type="button" id="active_deactive_adLocation" class="btn btn-primary">Đồng ý</button>
          </div>
        </div>
        <!-- /.modal-content -->
      </div>
  ...
  <!-- /.content-wrapper -->
  <%@ include file = "creativeImagePopup.jsp" %>
...
<script src="${contextPath}/resources/js/creativeImagePopup.js"></script>
<script src="${contextPath}/resources/js/adLocation.js"></script>
</body>
</html>
