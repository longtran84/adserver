...
public class UserMobileServiceImpl implements UserMobileService {
    ...
    public List<UserInfoDTO> getUserInfo(Date from, Date to) {
        ...
        for (Object row[] : result) {
            ...
            BigInteger dob = (BigInteger)row[3];
            ...
            Date createdDate = (Date)row[9];
            String interests = (String)row[10];
            BigInteger devices = (BigInteger)row[11];
            String userInvite  = (String)row[12];
